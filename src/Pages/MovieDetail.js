...
export const MovieDetail = ( ) => {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=b29a762571ae6734b4e6f49629ecffa7`);
...
<p className="my-4">
  ...
  <a href={`https://www.imdb.com/title/${movie.imdb_id}`} target="_black" rel="noreferrer">{movie.imdb_id} min.</a>
