...
if(darkMode){
  ...
  return (
    <header>
    <nav className="bg-white border-b-2 border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900 dark:border-b-1">
      <div className="flex flex-wrap items-center justify-between mx-auto">
      <Link to="/" className="flex items-center">
          <img src={ Logo } className="h-8 mr-3 sm:h-9" alt="CineMatica Logo" />
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CineMatica</span>
      </Link>
